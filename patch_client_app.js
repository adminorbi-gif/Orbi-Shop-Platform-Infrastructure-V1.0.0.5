...
const startIdx = content.indexOf(\`  if (!inv) return <div className="p-8 text-center text-slate-500 font-bold">{lang === "sw" ? "Inapakia..." : "Loading..."}</div>;\`);
if (startIdx === -1) {
...
const newContent = before + updatedStart + updatedReturn + \`\\n}\` + after;

fs.writeFileSync(path, newContent);
console.log("Updated ClientApp.tsx successfully");
